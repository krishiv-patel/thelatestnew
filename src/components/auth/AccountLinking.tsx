...
const allowedHosts = ['microsoft.com', 'google.com'];
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-4 bg-white rounded-lg border">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            onClick={() => isAllowedHost('https://google.com') && connectedProviders.includes('google.com') 
            ...
            className={`px-4 py-2 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 ${
              isAllowedHost('https://google.com') && connectedProviders.includes('google.com')
